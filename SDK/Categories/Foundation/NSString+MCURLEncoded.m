...
//#import "NSObject+ApiParam.h"
//#import "UserSession.h"
//#import "User.h"

@implementation NSString (MCURLEncoded)
...
//        [mutableString appendString:@"https://"];
//    }
//
//    NSRange range = [self rangeOfString:@"?" options:NSBackwardsSearch];
//    NSMutableDictionary *apiDictionary = [self MMapiDictionary];
//    apiDictionary[@"mobileInfo"] = [SDiOSVersion deviceNameString];
//    if (range.location != NSNotFound) {
//        [mutableString appendString:[self substringWithRange:NSMakeRange(0, range.location)]];
//        [mutableString appendString:[[self substringFromIndex:range.location + 1] urlParamString:apiDictionary]];
//    } else {
//        [mutableString appendString:self];
//        [mutableString appendString:[self urlParamString:apiDictionary]];
//    }
