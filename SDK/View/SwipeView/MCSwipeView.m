...
//  Get the latest version of MCSwipeView from here:
//
...
- (CGSize)swipeViewItemSizeXL:(__unused MCSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused MCSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused MCSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused MCSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused MCSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused MCSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused MCSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused MCSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused MCSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused MCSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface MCSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)updateItemSizeAndCount
{
    ...
    //get item size
    CGSize size = [_delegate swipeViewItemSizeXL:self];
