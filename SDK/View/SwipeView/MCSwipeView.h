...
- (void)swipeViewCurrentItemIndexDidChange:(MCSwipeView *)swipeView;
- (void)swipeViewWillBeginDragging:(MCSwipeView *)swipeView;
- (void)swipeViewDidEndDragging:(MCSwipeView *)swipeView willDecelerate:(BOOL)decelerate;
- (void)swipeViewWillBeginDecelerating:(MCSwipeView *)swipeView;
- (void)swipeViewDidEndDecelerating:(MCSwipeView *)swipeView;
- (void)swipeViewDidEndScrollingAnimation:(MCSwipeView *)swipeView;
- (BOOL)swipeView:(MCSwipeView *)swipeView shouldSelectItemAtIndex:(NSInteger)index;
- (void)swipeView:(MCSwipeView *)swipeView didSelectItemAtIndex:(NSInteger)index;
